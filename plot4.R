...
# Top right graph
plot(data_subset$Date_Time, data_subset$Voltage, 
     xaxt=NULL, 
     xlab = "datetime", 
     ylab = "Voltage", 
     type="n")
...
plot(data_subset$Date_Time, data_subset$Sub_metering_1, 
     xaxt=NULL, 
     xlab = "", 
...
# Bottom right graph
plot(data_subset$Date_Time, data_subset$Global_reactive_power, 
     xaxt=NULL, 
     xlab = "datetime", 
